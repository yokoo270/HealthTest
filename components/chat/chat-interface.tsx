...
export function ChatInterface() {
  ...
  const createNewChat = () => {
    const newSession: ChatSession = {
      ...
      messages: [
        {
          id: "welcome",
          content: `Hello ${user?.name}! I'm HealthMaxx AI, your personal fitness and health coach powered by advanced AI. I can create personalized workout routines, provide nutrition advice, track your progress, and help you achieve your fitness goals. What would you like to work on today?`,
          role: "assistant",
          timestamp: new Date(),
          type: "text",
        },
  ...
  const generateAIResponse = async (userMessage: string): Promise<void> => {
    try {
      ...
      const context = `User: ${user?.name}, Fitness Level: ${user?.fitnessLevel || "Not specified"}, Goals: ${user?.goals || "General fitness"}`
