    ...
    <section className="pt-32 pb-20 px-4">
      <div className="container mx-auto text-center">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-black mb-8">
          ...
          <br />
          <span className="text-foreground">{t("landing.title.sub")}</span>
        </h1>
          ...
          <div className="relative bg-card border border-border rounded-2xl p-8 shadow-2xl">
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-3xl font-serif font-black text-primary mb-2">1.2K+</div>
                <div className="text-muted-foreground">{t("landing.stats.users")}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-serif font-black text-secondary mb-2">8.5K+</div>
                <div className="text-muted-foreground">{t("landing.stats.workouts")}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-serif font-black text-accent mb-2">94%</div>
