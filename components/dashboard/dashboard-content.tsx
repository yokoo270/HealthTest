...
import { LogOut, User, Activity, Target, TrendingUp, MessageCircle, Bot, BarChart3, Home, Flame } from "lucide-react"
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h2 className="text-xl font-serif font-black">AI Fitness Coach</h2>
